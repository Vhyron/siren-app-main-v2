        ...
        if (id) {
          ...
          if (reportSnapshot.exists()) {
            ...
            if (reportData.senderId) {
              const userRef = ref(db, `users/${reportData.senderId}`);
              ...
              if (userSnapshot.exists()) {
                ...
                reportData.reporterName =
                  ...
                  "Unknown Reporter"; // Assign reporter's name
              } else {
                reportData.reporterName = "Unknown Reporter";
              }
            } else {
              reportData.reporterName = "Unknown Reporter";
            }
        ...
        <View style={styles.information}>
          ...
          <View style={styles.infoContainer}>
            <View style={styles.info}>
              ...
              <Text style={styles.infoDesc}>{formatNotificationTime(report?.createdAt) || "N/A"}</Text>
            </View>
            <View style={styles.info}>
            ...
            <View style={styles.info}>
              ...
              <Text style={styles.infoDesc}>
                {`${report?.location.latitude || "City"} ${
                  report?.location.longitude || "of Bacolod"
                }`}
              </Text>
            </View>
