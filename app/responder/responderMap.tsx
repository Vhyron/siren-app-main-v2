...
const ResponderMap = () => {
  ...
  const resetSelectedReport = () => {
    console.log("Resetting selected report");
  ...
  const handleMarkerPress = (report: any) => {
    if (report && report.location) {
      ...
      console.error("Report or location is undefined:", report);
    }
  };
  useEffect(() => {
  ...
  useEffect(() => {
    const startResponderLocationTracking = async () => {
      ...
      if (!responderId) {
        console.error(
          "Responder ID is undefined. User might not be logged in."
        );
        return;
      }
    ...
    const fetchReportsWithSenderNames = async () => {
      ...
      onValue(reportsRef, (snapshot) => {
        if (snapshot.exists()) {
          ...
          const reportPromises = Object.values(reportsData).map(
            async (report: any) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.headers}>
          <View style={styles.indexTopBar}>
            ...
            <TouchableOpacity
              onPress={() => router.navigate("/responder/")}
              activeOpacity={0.7}
            >
              <Image
          ...
          <View style={styles.bigTextContainer}>
            ...
            <Text style={styles.smallText}>
              Displays a live map view showing ongoing emergency responses for
        ...
        >
          ...
          {responderLocation && (
            <Marker
              coordinate={{
                latitude: responderLocation.latitude || 0,
                longitude: responderLocation.longitude || 0,
              }}
              title="Responder"
              pinColor="blue"
            />
        ...
        >
          <View style={styles.modal}>
            ...
            >
              ...
              <View>
                ...
                <Text style={styles.emergency}>
                  Emergency Type: {selectedReport?.category || ""}
                </Text>
              </View>
            </View>
            ...
            <Text style={[styles.headerText, styles.borderBottom]}>
              Emergency Details
            </Text>
          </View>
            ...
            <View style={styles.information}>
              ...
              <View style={styles.infoContainer}>
                ...
                <View style={styles.infoColumn}>
                  <Text style={[styles.infoHeaderText, styles.pad]}>
                    Emergency Details
                  </Text>
